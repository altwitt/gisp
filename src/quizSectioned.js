...
export const files = [
	{
		...
		link: "https://www.gisci.org/Portals/0/PDF's/BP%20crosswalk%20for%20dist%20w%202015%20Blueprint%207-19.pdf"
	},
	{
...
export const unorderedQuiz = [
	...
	{
		question: 'How is GIS different than CAD, Photogrammetrists, & Cartographers?',
	...
	},
	{
		...
		answer: 'Society, Employers and Funders, Colleagues and Profession, Individuals in Society'
	},
	{
	...
	{
		question: 'How would you comply with HIPPA laws if asked to map medical data?',
	...
	{
		question: 'What does the Federal Bureau of the Budget do in regards to mapping?',
	...
	{
		question: 'What is a .gpkg? What is it based on? Can it store both vector & raster data?',
		answer: 'A geopackageUniversal file format for geodata based on SQLLite. Yes, it supports both.'
	},
	{
	...
	{
		question: 'What is the vertical accuracy and percentage of points to pass a NMAS standard?',
	...
	{
		question: 'What does SDTS stand for? Is it for data accuracy or map accuracy?',
		answer:
	...
	{
		question: 'What percentage of accuracy is necessary for rasters to pass the SDTS standard?',
		answer: '95%'
	},
	{
	...
	{
		question: 'How would an image analyst check the accuracy of their classifications?',
		answer:
	...
	{
		question: "What is Kappa Coefficient? How is it different from Cohen's Kappa?",
		answer:
	...
	},
	{
		...
		answer: 'Are the cell values correct for conditions during the time period it was gathered?'
	},
	{
	...
	{
		question: 'Is the CSDGM standard required by the FGDC? If not, what does it endorse?',
		answer:
	...
	},
	{
		...
		answer: 'Title, Date, Geographic Location, Language, Topic Category, Abstract, Metadata'
	},
	{
	...
	},
	{
		...
		answer: 'a model of Earth using mean sea level as a baseEarth is not a perfect sphere'
	},
	{
	...
	{
		question: 'Should a map of a city/county use a spheroid/ellipsoid or a sphere?',
		answer:
	...
	},
	{
		...
		answer: 'In the United States the preferred spheroid is GRS_1980 which NAD83 is based off of.'
	},
	{
	...
	},
	{
		...
		answer: 'Geographic coordinate systems use lat/long to define a location on the Earth'
	},
	{
	...
	{
		question: 'Explain the steps from a geoid to a projected coordinate system.',
		answer:
	...
	{
		question: 'What is a HARN? What is it based off of? What coordinate systems use HARN?',
		answer: 'High Accuracy Reference Networksbased off of state level revisions to NAD83State Plane'
	},
	{
		question: 'What are the 2 most common reference frames used in the world today?',
		answer:
	...
	{
		question: 'What cartesian coordinate system is best for preserving distance?',
		answer: 'Equidistant Conic'
	},
	{
		question: 'What cartesian coordinate system is best for preserving direction?',
	...
	{
		question: 'What are some of the components of a projected coordinate system?',
	...
	{
		question: "What's the difference between a projection and a projected coordinate system?",
	...
	{
		question: 'What projection is used for states that are elongated in the north-south direction?',
	...
	{
		question: 'What projection is used for states that are elongated in the east-west direction?',
	...
	},
	{
		...
		answer: 'It is a unique name for each coordinate systemWGS84 Web Mercator, for example.'
	},
	{
	...
	{
		question: 'What is a international foot? How is it different from a US Foot?',
		answer:
			"US Survey foot is .304800609.... of a meterInt'l Foot is .3048 of a meterCan cause problems over a large area"
	},
	{
		question: 'NAD83 StatePlanes are in meters, but each state defines _________?',
	...
	},
	{
		...
		answer: 'Where plates are moving away from each other (mid Atlantic Ridge, for example)'
	},
	{
	...
	{
		question: 'What is a planar measurement? What is the only type of map it can be used on?',
	...
	},
	{
		...
		answer: 'Coordinate System, Author Name, Organization, Graticules, North Arrows'
	},
	{
		question: 'When is it appropriate to leave off a North Arrow on a map?',
		answer: 'If North is more than one direction (polar maps in conical projection, for example)'
	},
	{
		question:
	...
	},
	{
		...
		answer: 'hue - base colorsaturation - lightness or darkness of colorvalue - intensity of color'
	},
	{
	...
	{
		question: 'What is the difference between a proportional symbol and a graduated symbol?',
		answer:
	...
	{
		question: 'Lines of equal value: A map showing air pollution, rain fall, noise?',
		answer: 'Isoline'
	},
	{
	...
	},
	{
		...
		answer: 'one point from a set of ordered points that defines the shape of a polygon or line'
	},
	{
	...
	},
	{
		...
		answer: 'A curve is defined by verticesA true curve is defined and stored as an equation'
	},
	{
	...
	{
		question: 'What is the difference between a centroid, an area, and a perimeter?',
		answer:
	...
	},
	{
		...
		answer: 'Features, Attributes, Spatial Information (Projected or Geographic Coordinate System)'
	},
	{
	...
	{
		question: 'What is a coverage? How is it different from a feature class or shapefile?',
		answer:
	...
	{
		question: 'What is a .mdb extension on a folder mean? What is the size limit?',
	...
	{
		question: 'How is a raster catalog or mosaic raster dataset best described?',
		answer:
	...
	{
		question: 'ASCII files are associated with what company and what file type?',
		answer: 'ESRI GRID'
	},
	{
	...
	},
	{
		...
		answer: 'Database format, used by shapefiles and is a standard exchange format'
	},
	{
	...
	},
	{
		...
		answer: 'Point lines and polygons with Z valuesRastersTINMultipatchPoint CloudLiDAR'
	},
	{
	...
	{
		question: 'What is the performance difference between a map service and a feature service?',
		answer: 'Map services render server side, feature services render on the user side'
	},
	{
	...
	},
	{
		...
		answer: 'Metadata, GDB Schema, Exporting Database (data & schema), Format of GML & KML/KMZ'
	},
	{
	...
	{
		question: 'Is generalization better used for larger or smaller scaled maps?',
		answer: 'Small'
	},
	{
		question: ' What type of data is best represented by differing sizes of same shapes?   ',
		answer: 'Ordinal and interval data (shows quantitative differences)   '
	},
	{
		question: 'What is the difference between a DISCRETE RASTER and a CONTINUOUS RASTER?',
		answer:
	...
	{
		question: 'What are some commonly-used techniques to indicate elevation in a 2D map?',
	...
	{
		question: "If developing standards were a symphony, what would be ISO's role?",
	...
	{
		question: 'What is the accuracy of a consumer/recreational grade GPS device?',
	...
	{
		question: "What are some important questions to ask about data to ensure it's accurate?",
		answer:
	...
	},
	{
		...
		answer: 'A raster that has been classificed into 2 classes (1, 0 or true or false)'
	},
	{
	...
	},
	{
		...
		answer: 'Aligning unreferenced data to a dataset that is spatially referenced'
	},
	{
	...
	{
		question: 'Can you georeference an image to an unprojected coordinate system?',
		answer: 'Points that have exact matches between the referenced and unreferenced datasets'
	},
	{
		question:
			'What should you do if your basemap and scanned map are in different coordinate systems?',
		answer: 'No. The image must be georeferenced to a projected (cartesian) coordinate system'
	},
	{
	...
	{
		question: 'Define the similarity transformation type of georeferencing. What does it preserve?',
		answer: 'Residual should be 10x less than mapped feature (review this and check)'
	},
	{
	...
	{
		question: 'What type of georeferencing uses 6 links? What type of transformation is it?',
		answer:
			'Adds the ability to skew the image as well as scale, rotate, and translate from the similarity transformation.'
	},
	{
		question: 'What type of georeferencing uses 10 links? What type of transformation is it?',
	...
	},
	{
		...
		answer: 'Used to correct aerials, taking into account distortion away from from flight path'
	},
	{
		question:
	...
	{
		question: 'GPS satellites orbit the Earth _________ a day at an altitude of ___________ miles.',
		answer:
	...
	{
		question: 'Do SPS accuracy commitments apply to receivers or satellite signals?',
		answer: 'Satellite signals. They do not guarantee the accuracy of individual GPS devices.'
	},
	{
		question: 'For GPS signals, what level of accuracy does the government commit to?',
	...
	{
		question: "What is the preferred PDOP for collecting data? What's a great PDOP?",
		answer: 'The lower the PDOP the better. PDOP of 6 is good enough, PDOP of 4 is great.'
	},
	{
	...
	{
		question: 'What does CDMA stand for? What does it do and why is it necessary?',
		answer:
	...
	},
	{
		...
		answer: 'Known points (control stations) across the United States with exact locations'
	},
	{
	...
	{
		question: 'What is a total station? How is it similar/different than a theolodite?',
		answer:
	...
	},
	{
		...
		answer: 'Transits are simpler forms of a theodolite and the pros are that it is lightweight.'
	},
	{
	...
	{
		question: 'What kind of license do you need to fly a drone higher than 400ft?',
		answer: 'Part 107'
	},
	{
	...
	{
		question: 'When selecting by location, what does are within a distance of select?',
		answer:
			'Creates buffers around source layer and selects features within those areasSeattle is within 20 miles of Bellevue'
	},
	{
		question: 'When selecting by location, what does have their centroid within select?',
		answer:
	...
	{
		question: 'When selecting by location, what does share a line segment with select?',
		answer:
	...
	{
		question: 'When selecting by location, what does touch the boundary of select?',
		answer:
	...
	{
		question: 'When selecting by location, what does are crossed by the outline of select?',
		answer:
	...
	{
		question: 'When selecting by location, what does completely contain select?',
		answer:
	...
	{
		question: 'When selecting by location, what does contain Clementini select?',
		answer:
	...
	{
		question: 'When do you use quotes and when do you not use quotes on data for queries in SQL?',
		answer: 'Text needs quotes, integers do not'
	},
	{
		question:
			'What would this query select? StreetName = Olive AND SpeedLimit = 55 OR SpeedLimit = 55',
		answer: 'Segments of Olive that are 55mph and any road segment with a speed limit of 55mph.'
	},
	{
		question:
	...
	{
		question: 'What does the Intersect tool do? How is it different from Union?',
		answer:
	...
	{
		question: 'When doing a raster overlay, both rasters need to ______________?',
		answer: 'Be in the same coordinate system'
	},
	{
		question: 'What does generalization do to data? What are some advantages of generalization?',
		answer:
	...
	},
	{
		...
		answer: 'Parenthesis, Exponents, Multiplication, Division, Addition, Subtraction'
	},
	{
